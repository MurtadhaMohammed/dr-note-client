...
import { createPatient, createVisit, getVisits,updateVisit } from "../src/db/controllers"
...
function App() {
  ...
  useEffect(() => {
    ...
    // rItem(3, orderData, (resp) => {
      //   if (resp.status) {
      //     alert("Update OrderItem succefully");
      //   } else {
      //     alert("error");
      //   }
      // });
  
      // get Trashed Order (status = false)
      // getTrashedOrderItem((resp) => {
      //   if (resp.status) {
      //     console.log(resp.orderItems);
      //   } else {
      //     alert("error");
      //   }
      // });
  
      // deleteOrderItems(4, (resp) => {
      //     if (resp.status) {
      //       alert("delete order succefully");
      //     } else {
      //       alert("error");
      //     }
      //   });
