...
// export const getTrashedVisit = async (callback) => {
//     const visit = await Visit.findAll({
//         where: {
//             status: false
//         }
//     });
//     if (orderItems.every((orderItem) => orderItem instanceof OrderItem)) {
//         callback({
//             status: true,
//             orderItems: JSON.parse(JSON.stringify(orderItems, null, 2)),
//         });
//     } else {
//         callback({ status: false });
//     }
